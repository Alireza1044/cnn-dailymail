...
all_train_urls = "/Users/alireza/Desktop/Code/Internship/cnn-dailymail/url_lists/all_train.txt"
all_val_urls = "/Users/alireza/Desktop/Code/Internship/cnn-dailymail/url_lists/all_val.txt"
all_test_urls = "/Users/alireza/Desktop/Code/Internship/cnn-dailymail/url_lists/all_test.txt"
...
def tokenize_stories(stories_dir, tokenized_stories_dir):
    ...
    command = ['java', '-cp', '/content/stanford-corenlp-4.1.0/stanford-corenlp-4.1.0.jar',
...
def write_to_bin(url_file, out_file, makevocab=False):
    ...
    with open(out_file, 'wb') as writer:
        for idx, s in enumerate(story_fnames):
            ...
            article, abstract = get_art_abs(os.path.join(url_file, s))
...
if __name__ == '__main__':
    ...
    write_to_bin(cnn_stories_dir, os.path.join(finished_files_dir, "val.bin"))
    write_to_bin(cnn_stories_dir, os.path.join(finished_files_dir, "train.bin"), makevocab=True)
