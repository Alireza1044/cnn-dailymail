...
all_train_urls = "/content/drive/url_lists/all_train.txt"
all_val_urls = "/content/drive/url_lists/all_val.txt"
all_test_urls = "/content/drive/url_lists/all_test.txt"
